...
#################################################################################################
# This script is conceived to extract Google Trends series for divorce-related queries
#################################################################################################
...
#install.packages(c("dplyr","haven","gtrendsR","tidyverse","readr"))
library(dplyr)
library(haven)
library(gtrendsR)
library(tidyverse)
...
# Specify the path to stock the Google Trends data
# I set it to the working directory but you can do otherwise

pathwd <- "path\\of\\your\\data\\directory"
...
# You need to run this code several times modifying the keywords selected
