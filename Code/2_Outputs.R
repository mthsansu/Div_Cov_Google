...
#################################################################################################
# This script is conceived to create descriptive statistics, to plot time series and
# to compile outliers of our series
#################################################################################################
...
#install.packages(c("readxl","dplyr","haven","readr","data.table","zoo","FIACH","pracma",
#                   "purrr","ggplot2","ggthemes","ggfortify","forecast","tseries"))
library(readxl)
library(dplyr)
library(haven)
library(readr)
